 ...
 * VlRequestForm
 *
 * @ORM\Table(name="vl_request_form", indexes={@ORM\Index(name="vl_request_form_ibfk_5", columns={"result_status"})})
 * @ORM\Entity
 */
class VlRequestForm
{
    ...
    public function setPickedBy(?int $pickedBy): self
    {
    ...
    public function getResultStatus(): ?RSampleStatus
    {
        return $this->resultStatus;
    }

    public function setResultStatus(?RSampleStatus $resultStatus): self
    {
