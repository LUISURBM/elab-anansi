  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
		...
		<tr>
		    <td style=""><b>Specimen Collection Date&nbsp;:</b></td>
		    <td>
		...
		<div class="row" style="background:#e0e0e0;float: right !important;padding: 15px;">
		    <div class="col-md-12" >
			    ...
			    <div class="col-md-3">
				    <input type="checkbox" onclick="javascript:fnShowHide(this.value);" value="5" id="iCol5" data-showhide="patient_first_name" class="showhideCheckBox" /> <label for="iCol4">Patient's  Last  Name</label> <br>
			    </div>
			    <div class="col-md-3">
				    <input type="checkbox" onclick="javascript:fnShowHide(this.value);" value="6" id="iCol6" data-showhide="facility_name"  class="showhideCheckBox" /> <label for="iCol5">Facility Name</label>
			    </div>
			    <div class="col-md-3">
				    <input type="checkbox" onclick="javascript:fnShowHide(this.value);" value="7" id="iCol7" data-showhide="state"  class="showhideCheckBox" /> <label for="iCol6">Province</label>
			    </div>
			    <div class="col-md-3">
				    <input type="checkbox" onclick="javascript:fnShowHide(this.value);" value="8" id="iCol8" data-showhide="district"  class="showhideCheckBox" /> <label for="iCol7">District</label>
			    </div>
			    <div class="col-md-3">
				    <input type="checkbox" onclick="javascript:fnShowHide(this.value);" value="9" id="iCol9" data-showhide="sample_name"  class="showhideCheckBox" /> <label for="iCol8">Sample Type</label>
			    </div>
			    <div class="col-md-3">
				    <input type="checkbox" onclick="javascript:fnShowHide(this.value);" value="10" id="iCol10" data-showhide="result"  class="showhideCheckBox" /> <label for="iCol9">Result</label>
			    </div>
			</div>
		  </div>
	    </span>
  ...
  function loadResultStatusData(){
    $.blockUI();
     oTable = $('#vlTestResultStatusDataTable').dataTable({
	      ...
	      aoData.push({"name": "siteType", "value": $("#sampleType").val()});
              $.ajax({
                  "dataType": 'json',
                  "type": "POST",
                  "url": sSource,
