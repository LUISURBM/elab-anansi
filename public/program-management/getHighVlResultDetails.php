...
$thresholdLimit = $arr['viral_load_threshold_limit'];
	...
	if(isset($_POST['hvlBatchID']) && trim($_POST['hvlBatchID'])!= ''){
	    $sWhere = $sWhere.' AND b.batch_code LIKE "%'.$_POST['hvlBatchID'].'%"';
	}
	...
	if(isset($_POST['hvlSpecimenTestDate']) && trim($_POST['hvlSpecimenTestDate'])!= ''){
	...
	if(isset($_POST['hvlSpecimenType']) && $_POST['hvlSpecimenType']!=''){
		$sWhere = $sWhere.' AND s.sample_id = "'.$_POST['hvlSpecimenType'].'"';
	}
	if(isset($_POST['hvlSiteName']) && $_POST['hvlSiteName']!=''){
		$sWhere = $sWhere.' AND f.facility_id IN ('.$_POST['hvlSiteName'].')';
	}
