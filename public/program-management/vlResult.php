    ...
    <section class="content">
      <div class="row">
		...
		<tr>
		  ...
		  <td><b>Show only Reordered Specimen&nbsp;:</b></td>
		    <td>
	    ...
	    <span style="display: none;position:absolute;z-index: 9999 !important;color:#000;padding:5px;" id="showhide" class="">
			<div class="row" style="background:#e0e0e0;padding: 15px;margin-top: -25px;">
			    <div class="col-md-12" >
				    ...
				    <div class="col-md-3">
					    <input type="checkbox" onclick="javascript:fnShowHide(this.value);" value="3" id="iCol3" data-showhide="patient_first_name" class="showhideCheckBox"  /> <label for="iCol3">Patient's First Name</label> <br>
				    </div>
				    <div class="col-md-3">
