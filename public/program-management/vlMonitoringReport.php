<?php
$title = "eVLIS | VL Quarterly Monitoring Report";
include('../header.php');
      ...
      <div class="row">
		...
		<tr>
		  <td colspan="4">&nbsp;<input type="button" onclick="searchVlRequestData();" value="Search" class="btn btn-success btn-sm">
			...
			&nbsp;<button class="btn btn-info" type="button" onclick="exportAllExcelMonitoring()">Export to excel</button>
			</td>
		</tr>
	    </table>
            <!-- /.box-header -->
...
function paintMonths(){
 ...
 function exportAllExcelMonitoring(){
	$("#vlMonitoringTable").table2excel({
		exclude: ".noExl",
		name: "VL Monitoring Report",
		filename: "VL Monitoring Report Excel",
		fileext: ".xls",
		exclude_img: true,
		exclude_links: true,
		exclude_inputs: true
