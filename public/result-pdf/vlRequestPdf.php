...
$rejectionrResult = $db->rawQuery($rejectionrQuery);
    ...
    $reject = '<td>:&nbsp;<input type="radio" name="reject" value="yes" checked="checked" readonly="true"/>Yes&nbsp;<input type="radio" name="reject" value="no" readonly="true"/>No</td>';
     ...
     $reject = '<td>:&nbsp;<input type="radio" name="reject" value="yes" readonly="true"/>Yes&nbsp;<input type="radio" name="reject" value="no" readonly="true"/>No</td>';
        ...
        $html .='</tr>';
        $html.='</table><br/><br/>';
        $html.='<table><tr><td><h4>Site Details</h4>';
        $html.='<table style="padding:5px;width:98%;border:2px solid #333;">';
         $html.='<tr>';
          $html.='<td>Site Name:'.ucwords($result[0]['facility_name']).'&nbsp;Region:'.ucwords($result[0]['facility_state']).'</td>';
         $html.='</tr>';
         $html.='<tr>';
         ...
         $html.='</tr>';
        $html.='</table></td>';
        $html.='<td><h4>Specimen Details</h4><table style="padding:5px;border:2px solid #333;">';
         $html.='<tr style="width:98%;">';
          $html.='<td>Date Of Specimen Collection:'.$result[0]['sample_collection_date'].'</td>';
         $html.='</tr>';
         $html.='<tr style="width:98%;">';
          $html.='<td>Specimen Received Date:'.$result[0]['sample_received_at_vl_lab_datetime'].'</td>';
         $html.='</tr>';
         $html.='<tr>';
          $html.='<td>Specimen Type:'.$div.'</td>';
         $html.='</tr>';
        $html.='</table></td></tr>';
        $html.='</table>';
        $html.='<h4>Patient Details</h4>';
        $html.='<table style="padding:5px;border:2px solid #333;">';
        $html.='<tr><td>Unique ART No.</td><td>:&nbsp;'.$result[0]['patient_art_no'].'</td><td>Specimen ID</td><td>:&nbsp;'.$result[0]['sample_code'].'</td></tr>';
