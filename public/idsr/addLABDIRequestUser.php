<?php
ob_start();
$title = "eVLIS | Add New IDSR Request";
include('../header.php');
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1><i class="fa fa-edit"></i> LABORATORY IDSR REPORT FORM </h1>
        <ol class="breadcrumb">
                        ...
                        <div class="widget-content">
                            <div class="bs-example bs-example-tabs">
                                <ul id="myTab" class="nav nav-tabs">
                                    <li><a href="addDIRequestUser.php" data-toggle="tab">Generic Form</a></li>
                                    <li class="active"><a href="#clinicInformation" data-toggle="tab">Laboratory Form</a></li>
                                </ul>
                                <div id="myTabContent" class="tab-content" >
                                    <div class="tab-pane fade in active" id="clinicInformation">
                                        ...
                                        <div class="box-footer">
                                            <a class="btn btn-primary" href="#patientInformation" data-toggle="tab">Save and Next</a>
                                    ...
                                    <div class="tab-pane fade" id="patientInformation">
                                        ...
                                        <div class="box-footer">
                                            <a class="btn btn-primary" href="#specimenInformation" data-toggle="tab">Save and Next</a>
                                            <a href="vlRequest.php" class="btn btn-default"> Cancel</a>
                                        </div>
                                    </div>
...
<!--                                                                <input type="text" class="form-control" id="reqClinician" name="reqClinician" placeholder="Request Clinician" title="Please enter request clinician" />-->
                                        ...
                                        <div class="box-footer">
                                            <a class="btn btn-primary" href="#laboratoryInformation" data-toggle="tab">Save and Next</a>
                                            <a href="vlRequest.php" class="btn btn-default"> Cancel</a>
                                        </div>
                                    </div>
                                                ...
                                                <div class="box-body">
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            ...
                                                            <div class="col-lg-7">
                                                                <select name="labId" id="labId" class="form-control" readonly title="Please choose lab" >
                                                                    <!--                                <option value="">-- Select --</option>-->
                                                                    <?php
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <div class="col-lg-7">
                                                                <input type="text" class="form-control" id="vlFocalPerson" name="vlFocalPerson" placeholder="VL Focal Person" title="Please enter vl focal person name" readonly value="<?php echo $labName['contact_person'];?>" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <label for="vlFocalPersonPhoneNumber" class="col-lg-5 control-label">VL Focal Person Phone Number</label>
                                                            <div class="col-lg-7">
                                                                <input type="text" class="form-control checkNum" id="vlFocalPersonPhoneNumber" name="vlFocalPersonPhoneNumber" maxlength="15" placeholder="Phone Number" title="Please enter vl focal person phone number" readonly value="<?php echo $labName['facility_mobile_numbers'];?>"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4 vlResult">
                                                            ...
                                                            <div class="col-lg-7">
                                                                ...
                                                                <input type="checkbox" class="" id="bdl" name="bdl" value="yes" title="Please check bdl"> < 20
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
