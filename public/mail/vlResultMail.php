<?php
ob_start();
$title = "eVLIS | Email VL Test Results";
include('../header.php');
...
<style>
    ...
    <section class="content">
      ...
      <div class="box box-default">
		...
		<div class="row">
                    <div class="col-md-9">
                    <div class="form-group">
                        <label for="facility" class="col-lg-3 control-label">Site Name (To)<span class="mandatory">*</span></label>
                        <div class="col-lg-9">
                          <select class="form-control isRequired" id="facility" name="facility" title="Please select site name">
		...
		<div class="row">
                    ...
                    <div class="col-md-12">
                        <table class="table" cellpadding="1" cellspacing="3" style="margin-left:1%;margin-top:20px;width:90%;">
                            ...
                            <tr>
                                 <td>&nbsp;<b>Site Name&nbsp;:</b></td>
                                    <td>
                                        <select style="width: 275px;" class="form-control" id="facilityName" name="facilityName" title="Please select site name"  multiple="multiple">
                                        <?php
			    ...
			    <tr>
                                <td>&nbsp;<b>Region &nbsp;:</b></td>
                                <td>
				    <select name="state" id="state" class="form-control" title="Please choose region" onchange="getProvinceDistricts();" style="width:275px;">
                                          <option value=""> -- Select -- </option>
                                          <?php
                                ...
                                <td>
                                    <select name="batch" id="batch" class="form-control" title="Please choose batch" style="width:275px;" multiple="multiple">
                                          ...
                                          <?php } ?>
																...
																<td class=""><b>Specimen Status&nbsp;:</b></td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="sampleMailSentStatus" id="sampleMailSentStatus" class="form-control" title="Please choose sample mail sent status" style="width:275px;">
                                            <option value="no">Specimen Not yet Mailed</option>
                                            <option value="">All Specimen</option>
                                            <option value="yes">Already Mailed Specimen</option>
                                    </select>
                                </td>
																<td></td>
																<td></td>
                ...
                <div class="row" id="sampleDetails">
                    <div class="col-md-9">
                    <div class="form-group">
                        <label for="sample" class="col-lg-3 control-label">Choose Specimen <span class="mandatory">*</span></label>
                        <div class="col-lg-9">
  ...
  $(document).ready(function() {
      ...
      $('#facility').select2({placeholder: "Select Site"});
      ...
      $('.search').multiSelect({
       selectableHeader: "<input type='text' class='search-input form-control' autocomplete='off' placeholder='Enter Specimen ID'>",
       selectionHeader: "<input type='text' class='search-input form-control' autocomplete='off' placeholder='Enter Specimen ID'>",
  ...
  $('#facility').change(function(e){
	...
	if($.trim(toEmailId) == ''){
	  $('.emailSection').html('No valid Email id available. Please add valid email for this site..');
	}else{
	  $('.emailSection').html('<mark>This email will be sent to the site with an email id <strong>'+toEmailId+'</strong></mark>');
	}
	$('#toName').val(toName);
