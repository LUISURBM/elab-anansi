...
if(isset($_SESSION['privileges']) && array_intersect($_SESSION['privileges'], array('addImportResult.php','vlTestResult.php'))) {
...
if(isset($_SESSION['privilegees']) && array_intersect($_SESSION['privilegees'], array('addImportResult.php','vlTestResult.php'))) {
...
if(isset($_SESSION['privileges']) && array_intersect($_SESSION['privileges'], array('missingResult.php', 'vlResult.php','highViralLoad.php','vlPrintResult.php'))) {
...
if(isset($_SESSION['privilegees']) && array_intersect($_SESSION['privilegees'], array('missingResult.php', 'vlResult.php','highViralLoad.php','vlPrintResult.php'))) {
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo($dashBoardMenuAccess == true)?'../dashboard/index.php':'#'; ?>" class="logo">
        <a href="<?php echo($dashBoardMenuAcceess == true)?'../dashboard/index.php':'#'; ?>" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini"><b>eLabMessenger</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg">eLabMessenger</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          <li class="dropdown user user-menu">
            ...
            <!--  <li class="user-footer">
			  ...
			  <li class="user-footer">
                  <a href="https://issuelog.nacp.org.gh/issue" target ="_blank" style="color:blue" class="">Having Issues? Report Here !!!</a>
              </li>
            </ul>
          </li>
        </ul>
