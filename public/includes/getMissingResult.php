...
?>
<div id="sampleStatusOverviewContainer" style="float:left;min-width: 580px; height: 480px; max-width: 500px; margin: 0 auto;"></div>
<div id="samplesVlOverview" style="float:right;min-width: 610px; height: 480px; max-width: 600px; margin: 0 auto;"></div>
...
<script>
    ...
    if(isset($tResult) && count($tResult)>0){ ?>
      $('#sampleStatusOverviewContainer').highcharts({
                ...
                title: {
                    text: 'Specimen Status Overview'
                },
                credits: {
                  enabled: false
               },
                tooltip: {
                    pointFormat: 'Specimen :<b>{point.y}</b>'
                },
                plotOptions: {
                    pie: {
                        size:'100%',
