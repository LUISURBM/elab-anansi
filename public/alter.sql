...
ALTER TABLE `vl_request_form` CHANGE `patient_name` `patient_middle_name` VARCHAR(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL;
...
RENAME TABLE `testing_status` TO `r_sample_status`;
