	    ...
	    <span style="display: none;position:absolute;z-index: 9999 !important;color:#000;padding:5px;" id="showhide" class="">
			<div class="row" style="background:#e0e0e0;float: right !important;padding: 15px;">
			   <div class="col-md-12" >
				    ...
				    <div class="col-md-3">
					    <input type="checkbox" onclick="javascript:fnShowHide(this.value);" value="4" id="iCol4" data-showhide="patient_first_name" class="showhideCheckBox" /> <label for="iCol4">Patient's First Name</label> <br>
				    </div>
				    <div class="col-md-3">
					    <input type="checkbox" onclick="javascript:fnShowHide(this.value);" value="5" id="iCol5" data-showhide="patient_last_name" class="showhideCheckBox" /> <label for="iCol5">Patient's Last Name</label> <br>
				    </div>
				    <div class="col-md-3">
					    <input type="checkbox" onclick="javascript:fnShowHide(this.value);" value="6" id="iCol6" data-showhide="facility_name"  class="showhideCheckBox" /> <label for="iCol5">Site Name</label>
				    </div>
				   <div class="col-md-3">
					    <input type="checkbox" onclick="javascript:fnShowHide(this.value);" value="7" id="iCol7" data-showhide="state"  class="showhideCheckBox" /> <label for="iCol6">Region</label>
				    </div> 
				    <div class="col-md-3">
					    <input type="checkbox" onclick="javascript:fnShowHide(this.value);" value="9" id="iCol9" data-showhide="district"  class="showhideCheckBox" /> <label for="iCol7">District</label>
				    </div>
				    <div class="col-md-3">
					    <input type="checkbox" onclick="javascript:fnShowHide(this.value);" value="10" id="iCol10" data-showhide="sample_name"  class="showhideCheckBox" /> <label for="iCol8">Specimen Type</label>
				    </div>
				    <div class="col-md-3">
					    <input type="checkbox" onclick="javascript:fnShowHide(this.value);" value="11" id="iCol11" data-showhide="result"  class="showhideCheckBox" /> <label for="iCol9">Result</label>
				    </div>
				    <div class="col-md-3">
					    <input type="checkbox" onclick="javascript:fnShowHide(this.value);" value="12" id="iCol12" data-showhide="status_name" class="showhideCheckBox" /> <label for="iCol10">Status</label>
				    </div>
				</div>
			    </div>
			</span>  
		  ...
		  <?php } ?>
                ...
                <tbody>
                  <tr>
                    <td colspan="10" class="">Loading data from server</td>
                </tr>
                </tbody>
              </table>
					<?php
