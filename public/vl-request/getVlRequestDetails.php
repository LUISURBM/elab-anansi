...
$primaryKey="vl_sample_id";
	...
	if($sWhere!=''){
	    $sWhere = $sWhere.' AND '.$whereResult.'vl.result_status not in (SELECT `status_id` FROM `r_sample_status` WHERE `status_name` = "Rejected")';
	}else{
	    $sWhere = $sWhere.' where '.$whereResult.'vl.result_status not in (SELECT `status_id` FROM `r_sample_status` WHERE `status_name` = "Rejected")';
	}
