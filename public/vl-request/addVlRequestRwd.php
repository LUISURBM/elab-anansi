                    ...
                    <div class="row">
                      <div class="col-xs-3 col-md-3">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control isRequired <?php echo $sampleClass;?>" id="sampleCode" name="sampleCode" <?php echo $maxLength;?> placeholder="Enter Specimen ID" title="Please enter sample id" style="width:100%;"/>
                        </div>
                      </div>
                      <div class="col-xs-3 col-md-3">
                        <div class="form-group">
