                      ...
                      <div class="row">
                        ...
                        <div class="col-md-4 vlResult" style="display:<?php echo($vlQueryInfo[0]['is_sample_rejected'] == 'yes')?'none':'block'; ?>;">
                            ...
                            <div class="col-lg-7">
                              ...
                              <input type="checkbox" class="labSection" id="bdl" name="bdl" value="yes" <?php echo($vlQueryInfo[0]['result'] == '< 20')?'checked="checked"':'';  echo($vlQueryInfo[0]['result'] == 'Target Not Detected')?'disabled="disabled"':'' ?> title="Please check bdl"> < 20 <br>
                            </div>
                        </div>
                      </div>
                      <div class="row">
